...
import center from '@/views/center'
    ...
    import kaoyan from '@/views/modules/kaoyan/list'
    ...
    import dictionaryKaoyan from '@/views/modules/dictionaryKaoyan/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryKaoyan',
        name: '考研信息类型',
        component: dictionaryKaoyan
    }
    ,{
        path: '/dictionaryNews',
        name: '公告类型',
