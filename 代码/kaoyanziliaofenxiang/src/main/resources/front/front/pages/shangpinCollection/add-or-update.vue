		...
		<form class="app-update-pv">
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f06f4f","textAlign":"left"}'
                          class="title">类型</view>
                    <picker @change="shangpinCollectionTypesChange" :value="shangpinCollectionTypesIndex" :range="shangpinCollectionTypesOptions" range-key="indexName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.shangpinCollectionTypes?ruleForm.shangpinCollectionValue:"请选择类型"}}</view>
                    </picker>
                </view>
...
<script>
	...
	export default {
		...
		/*下拉框*/
			...
			if(options.shangpinCollectionId){
                this.ruleForm.shangpinCollectionId = options.shangpinCollectionId;
			}
			// 跨表
			// this.styleChange()
		},
