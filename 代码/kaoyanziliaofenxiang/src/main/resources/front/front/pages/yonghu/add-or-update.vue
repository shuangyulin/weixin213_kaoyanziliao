	...
	<view class="content">
		<form class="app-update-pv">
                ...
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.yonghuPhoto" :src="ruleForm.yonghuPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f06f4f","textAlign":"left"}'
                      class="title">电子邮箱</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.yonghuEmail" type="text" v-model="ruleForm.yonghuEmail" placeholder="电子邮箱"></input>
            </view>
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if ((!this.ruleForm.yonghuEmail) && (!this.$validate.isEmail(this.ruleForm.yonghuEmail))) {
					this.$utils.msg(`电子邮箱不能为空并且需要输入正确格式`);
					return
				}
				if (this.ruleForm.id) {
